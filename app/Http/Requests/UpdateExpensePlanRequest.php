...
class UpdateExpensePlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'chart_of_account_id' => ['required', 'integer', Rule::exists('chart_of_accounts', 'id')->where('type', 'expense')],
    ...
    {
        $totalMonthly = array_sum(array_map(fn ($month) => (float) $this->input($month, 0), ExpensePlan::monthColumns()));
