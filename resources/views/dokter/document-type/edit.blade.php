                ...
                <form action="{{ route('dokter.document-types.update', $documentType->id) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="s3_filename_template" class="form-control @error('s3_filename_template') is-invalid @enderror" value="{{ old('s3_filename_template', $documentType->s3_filename_template) }}" maxlength="255">
