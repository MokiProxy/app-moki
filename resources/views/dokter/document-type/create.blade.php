    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('dokter.document-types.store') }}" method="POST" id="document-type-form">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="header_regex" id="header_regex" value="{{ old('header_regex') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="number_regex" id="number_regex" value="{{ old('number_regex', '/No\\s+Inv\\s*\\n?\\s*:\\s*(.+)/i') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="keterangan_regex" id="keterangan_regex" value="{{ old('keterangan_regex', '/Keterangan\\s*:\\s*(.+)/i') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="uraian_regex" id="uraian_regex" value="{{ old('uraian_regex', '/URAIAN\\s*\\n(.+?)\\n\\s*TOTAL/si') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="tanggal_regex" id="tanggal_regex" value="{{ old('tanggal_regex', '/Tgl\\s*\\n?\\s*:\\s*(.+)/i') }}">
