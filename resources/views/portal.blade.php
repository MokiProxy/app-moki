...
<head>
    ...
    <style>
        ...
        .menu-card p { font-size: 0.65rem; color: #64748b; margin-bottom: 0; }
        ...
        @media (max-width: 576px) {
            .header-portal { padding: 15px 20px; text-align: center; }
        ...
        <div class="profile-section">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                    <li><h6 class="dropdown-header">Aksi Pengguna</h6></li>
