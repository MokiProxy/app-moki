                ...
                <form action="{{ route('erkap.routine-costs.update', $routineCost->id) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="cost_category" class="form-select @error('cost_category') is-invalid @enderror" required>
                                <option value="" disabled {{ old('cost_category', $routineCost->cost_category) ? '' : 'selected' }}>Pilih Kategori Biaya</option>
                                <option value="Biaya Umum" {{ old('cost_category', $routineCost->cost_category) == 'Biaya Umum' ? 'selected' : '' }}>Biaya Umum</option>
                                <option value="Bahan Bakar Minyak" {{ old('cost_category', $routineCost->cost_category) == 'Bahan Bakar Minyak' ? 'selected' : '' }}>Bahan Bakar Minyak</option>
                                <option value="Sewa Kendaraan" {{ old('cost_category', $routineCost->cost_category) == 'Sewa Kendaraan' ? 'selected' : '' }}>Sewa Kendaraan</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="cost_center_id" class="form-control @error('cost_center_id') is-invalid @enderror" value="{{ old('cost_center_id', $routineCost->cost_center_id) }}" placeholder="Opsional">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="cost_center_owner" class="form-control @error('cost_center_owner') is-invalid @enderror" value="{{ old('cost_center_owner', $routineCost->cost_center_owner) }}" placeholder="Nama pemilik cost center" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" min="0" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price', $routineCost->unit_price) }}" required>
                            @error('unit_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Total</label>
                            <input type="number" step="0.01" min="0" name="total" id="total" class="form-control bg-light @error('total') is-invalid @enderror" value="{{ old('total', $routineCost->total) }}" readonly>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="0.01" min="0" name="{{ $field }}" class="form-control month-cost @error($field) is-invalid @enderror" value="{{ old($field, $routineCost->{$field}) }}">
