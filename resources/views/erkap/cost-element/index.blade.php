        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    <a href="{{ route('erkap.cost-elements.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-plus me-1"></i> Tambah Elemen Biaya
                    </a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="{{ $costElement->id }}" data-name="{{ $costElement->name }}" title="Hapus">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                title: 'Hapus Elemen Biaya?',
                text: 'Elemen biaya "' + name + '" akan dihapus permanen.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    form.attr('action', "{{ url('erkap/cost-elements') }}/" + id);
                    form.submit();
                }
            });
        });
