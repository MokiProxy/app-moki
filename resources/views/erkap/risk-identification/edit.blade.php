                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-4 form-control border-0 pt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="risk_direction" id="risk_direction_negative" value="negative" {{ old('risk_direction', $riskIdentification->risk_direction) == 'negative' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="risk_direction_negative">Negatif</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="risk_direction" id="risk_direction_positive" value="positive" {{ old('risk_direction', $riskIdentification->risk_direction) == 'positive' ? 'checked' : '' }}>
