    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.revenue-plans.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="2" placeholder="Keterangan rencana pendapatan">{{ old('description') }}</textarea>
