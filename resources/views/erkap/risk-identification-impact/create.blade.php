    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.risk-identification-impacts.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="impact" class="form-control @error('impact') is-invalid @enderror" value="{{ old('impact') }}" required maxlength="255">
