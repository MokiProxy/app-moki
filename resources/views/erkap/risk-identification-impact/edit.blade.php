        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('erkap.risk-identification-impacts.index') }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.risk-identification-impacts.update', $riskIdentificationImpact->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="erkap_risk_identification_id" class="form-select @error('erkap_risk_identification_id') is-invalid @enderror" required>
                                <option value="" disabled {{ old('erkap_risk_identification_id', $riskIdentificationImpact->erkap_risk_identification_id) ? '' : 'selected' }}>Pilih Identifikasi Risiko</option>
                                @foreach($riskIdentifications as $riskIdentification)
                                    <option value="{{ $riskIdentification->id }}" {{ old('erkap_risk_identification_id', $riskIdentificationImpact->erkap_risk_identification_id) == $riskIdentification->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="impact" class="form-control @error('impact') is-invalid @enderror" value="{{ old('impact', $riskIdentificationImpact->impact) }}" required maxlength="255">
                    ...
                    <div class="mt-4 border-top pt-3">
                        ...
                        <a href="{{ route('erkap.risk-identification-impacts.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
