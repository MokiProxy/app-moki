    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.rkap.update', $rkap->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="year" class="form-control @error('year') is-invalid @enderror" value="{{ old('year', $rkap->year) }}" required min="1900" max="2999" step="1" placeholder="contoh: 2026">
                    ...
                    <div class="mt-4 border-top pt-3">
                        ...
                        <a href="{{ route('erkap.rkap.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
