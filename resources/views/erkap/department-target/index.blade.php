        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    <a href="{{ route('erkap.department-targets.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-plus me-1"></i> Tambah Sasaran Departemen
                    </a>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle w-100">
                        ...
                        <tbody>
                            @forelse($departmentTargets as $key => $departmentTarget)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="{{ $departmentTarget->id }}" data-name="{{ $departmentTarget->target }}" title="Hapus">
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted">Belum ada data sasaran departemen.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="d-flex justify-content-end mt-3">
                    {{ $departmentTargets->links('pagination::bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                title: 'Hapus Sasaran Departemen?',
                text: 'Sasaran departemen "' + name + '" akan dihapus permanen.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    form.attr('action', "{{ url('erkap/department-targets') }}/" + id);
                    form.submit();
                }
            });
        });
