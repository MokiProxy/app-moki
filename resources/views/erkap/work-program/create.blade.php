                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" min="0" max="100" name="year_plan" id="input-year-plan" class="form-control @error('year_plan') is-invalid @enderror" value="{{ old('year_plan') }}" required>
