    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.work-programs.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" min="0" name="year_plan" class="form-control @error('year_plan') is-invalid @enderror" value="{{ old('year_plan') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="0.01" min="0" name="{{ $field }}" class="form-control @error($field) is-invalid @enderror" value="{{ old($field) }}">
