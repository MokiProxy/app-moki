                ...
                <form action="{{ route('erkap.work-programs.update', $workProgram->id) }}" method="POST" id="form-work-program">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" min="0" name="year_plan" id="input-year-plan" class="form-control @error('year_plan') is-invalid @enderror" value="{{ old('year_plan', $workProgram->year_plan) }}" required>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="0.01" min="0" name="{{ $field }}" class="form-control monthly-plan @error($field) is-invalid @enderror" value="{{ old($field, $workProgram->{$field}) }}" required>
