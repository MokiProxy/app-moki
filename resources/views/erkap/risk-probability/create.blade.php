    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.risk-probabilities.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="point" class="form-control @error('point') is-invalid @enderror" value="{{ old('point') }}" required min="1" step="1">
