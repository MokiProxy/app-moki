        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    <a href="{{ route('erkap.department-risk-strategies.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-plus me-1"></i> Tambah Strategi Risiko
                    </a>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle w-100">
                        ...
                        <tbody>
                            @forelse($departmentRiskStrategies as $key => $departmentRiskStrategy)
                            <tr>
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted">Belum ada data strategi risiko departemen.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="d-flex justify-content-end mt-3">
                    {{ $departmentRiskStrategies->links('pagination::bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                title: 'Hapus Strategi Risiko?',
                text: 'Strategi "' + name + '" akan dihapus permanen.',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    form.attr('action', "{{ url('erkap/department-risk-strategies') }}/" + id);
                    form.submit();
                }
            });
        });
