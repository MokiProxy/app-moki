        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    <a href="{{ route('erkap.cost-element-categories.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('erkap.cost-element-categories.edit', $category->id) }}" class="btn btn-warning btn-sm btn-edit" title="Edit">
                                        <i class="mdi mdi-pencil"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="{{ $category->id }}" data-name="{{ $category->name }}" title="Hapus">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted">Belum ada data kategori elemen biaya.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.attr('action', "{{ url('erkap/cost-element-categories') }}/" + id);
                    form.submit();
                }
            });
        });
