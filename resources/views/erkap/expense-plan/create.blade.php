    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.expense-plans.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select name="erkap_rkap_id" class="form-select @error('erkap_rkap_id') is-invalid @enderror" required>
                                ...
                                @foreach($rkaps as $rkap)
                                    <option value="{{ $rkap->id }}" {{ old('erkap_rkap_id') == $rkap->id ? 'selected' : '' }}>
                                        {{ $rkap->year }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="2" placeholder="Keterangan rencana beban">{{ old('description') }}</textarea>
