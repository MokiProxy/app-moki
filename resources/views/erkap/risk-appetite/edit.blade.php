        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('erkap.risk-appetites.index') }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.risk-appetites.update', $riskAppetite->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $riskAppetite->name) }}" required maxlength="255">
                    ...
                    <div class="mt-4 border-top pt-3">
                        ...
                        <a href="{{ route('erkap.risk-appetites.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
