        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('erkap.risk-impacts.index') }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('erkap.risk-impacts.update', $riskImpact->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $riskImpact->name) }}" required maxlength="255">
                            @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Point <span class="text-danger">*</span></label>
                            <input type="number" name="point" class="form-control @error('point') is-invalid @enderror" value="{{ old('point', $riskImpact->point) }}" required min="1" step="1">
                    ...
                    <div class="mt-4 border-top pt-3">
                        ...
                        <a href="{{ route('erkap.risk-impacts.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
