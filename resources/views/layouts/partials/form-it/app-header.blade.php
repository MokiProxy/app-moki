                    ...
                    <span class="logo-lg mt-4">
                        <div class="flex">
                            <h3 class="text-white mt-4 fw-bold d-flex gap-2 align-items-center">
                                <div class="bg-primary-form-it p-1 rounded d-flex justify-content-center align-items-center">
                                    <i class="mdi mdi-file-document-edit"></i>
                                </div>
                                <div class="d-flex justify-center flex-column">
                                    <div>
                                        <span class="text-{{ $roleColor }} m-0 p-0">Form</span> IT
                                    </div>
                                    <p class="fs-6 m-0 p-0 fw-normal">Aplikasi Formulir IT</p>
                                </div>
                            </h3>
                        </div>
                    </span>
