@include('layouts.partials.eqtax.app-head')
...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
        ...
        @include('layouts.partials.eqtax.app-header')
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <!--- Sidemenu -->
                @include('layouts.partials.eqtax.app-sidebar')
                <!-- Sidebar -->
            </div>
        </div>
        <!-- Left Sidebar End -->
        ...
        <div class="main-content">
            ...
            @include('layouts.partials.eqtax.app-footer')
        </div>
        <!-- end main content-->
