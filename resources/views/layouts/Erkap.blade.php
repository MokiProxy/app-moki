@include('layouts.partials.erkap.app-head')
...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
        ...
        @include('layouts.partials.erkap.app-header')
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <!--- Sidemenu -->
                @include('layouts.partials.erkap.app-sidebar')
                <!-- Sidebar -->
            </div>
        </div>
        <!-- Left Sidebar End -->
        ...
        <div class="main-content">
            ...
            @include('layouts.partials.erkap.app-footer')
        </div>
        <!-- end main content-->
