        ...
        <div class="card shadow-sm">
            <div class="card-body border-bottom bg-light">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('form-it.approval.index') }}" class="btn btn-secondary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card border-primary">
                            ...
                            <div class="card-body">
                                <form action="{{ route('form-it.approval.process', $softwareInstallation->id) }}" method="POST" id="approvalForm">
                                    @csrf
                                    <div class="mb-3">
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('form-it.approval.process', $softwareInstallation->id) }}" method="POST">
                @csrf
