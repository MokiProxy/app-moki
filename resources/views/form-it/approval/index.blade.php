                        ...
                        <table class="table table-striped table-bordered align-middle w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('form-it.approval.show', $item->id) }}" class="btn btn-sm btn-info">
                    ...
                    <div class="tab-pane fade" id="history-list">
                        <table class="table table-striped table-bordered align-middle w-100">
                            ...
                            <tbody>
                                ...
                                @php
                                    $myApproval = $item->approvals->firstWhere('approver_id', auth()->user()->employee_id);
                                @endphp
                                <tr>
                                    <td class="text-center">{{ $index + 1 }}</td>
                                    <td>{{ $item->created_at->format('d M Y') }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('form-it.approval.show', $item->id) }}" class="btn btn-sm btn-outline-secondary">
